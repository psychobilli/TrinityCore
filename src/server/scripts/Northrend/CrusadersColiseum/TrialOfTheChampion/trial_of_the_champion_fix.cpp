...
public:
    ...
    struct npc_announcer_toc5AI : public ScriptedAI
    {
        ...
        void StartGrandChampionsAttack()
        {
            ...
            {
                AggroAllPlayers(pGrandChampion1, true);
                AggroAllPlayers(pGrandChampion2, true);
                AggroAllPlayers(pGrandChampion3, true);
            }
        }
        ...
        void StartEncounter(bool startRp = false)
        {
            ...
            if (instance->GetBossState(BOSS_BLACK_KNIGHT) == NOT_STARTED || instance->GetBossState(BOSS_BLACK_KNIGHT) == TO_BE_DECIDED)
            {
                if (instance->GetBossState(BOSS_ARGENT_CHALLENGE) == NOT_STARTED || instance->GetBossState(BOSS_ARGENT_CHALLENGE) == TO_BE_DECIDED)
                {
                    // Starting Grand Champion event (with roleplaying)
                    if (startRp && (instance->GetBossState(BOSS_GRAND_CHAMPIONS) == NOT_STARTED || instance->GetBossState(BOSS_GRAND_CHAMPIONS) == TO_BE_DECIDED))
                    {
                        Talk(SAY_INTRO_1);
                ...
                if (instance->GetBossState(BOSS_GRAND_CHAMPIONS) == DONE && instance->GetBossState(BOSS_ARGENT_CHALLENGE) == DONE)
                    DoStartBlackKnight();
            }
        }
        ...
        void AggroAllPlayers(Creature* temp, bool riderAlso = false)
        {
        ...
        void UpdateAI(uint32 uiDiff) override
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_FACING_1:
                    ...
                    if (Creature* knight = instance->GetCreature(BOSS_BLACK_KNIGHT))
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (instance)
            {
                ...
                if (player->IsGameMaster())
                {
                    ...
                    if ((instance->GetBossState(BOSS_GRAND_CHAMPIONS) == NOT_STARTED || instance->GetBossState(BOSS_GRAND_CHAMPIONS) == TO_BE_DECIDED) &&
                        (instance->GetBossState(BOSS_ARGENT_CHALLENGE) == NOT_STARTED || instance->GetBossState(BOSS_ARGENT_CHALLENGE) == TO_BE_DECIDED) &&
                        (instance->GetBossState(BOSS_BLACK_KNIGHT) == NOT_STARTED || instance->GetBossState(BOSS_BLACK_KNIGHT) == TO_BE_DECIDED))
                    {
                ...
                else if ((instance->GetBossState(BOSS_GRAND_CHAMPIONS) == NOT_STARTED || instance->GetBossState(BOSS_GRAND_CHAMPIONS) == TO_BE_DECIDED) && player->GetVehicleBase())
                {
                ...
                else if (instance->GetBossState(BOSS_GRAND_CHAMPIONS) == DONE && (instance->GetBossState(BOSS_ARGENT_CHALLENGE) == NOT_STARTED || instance->GetBossState(BOSS_ARGENT_CHALLENGE) == TO_BE_DECIDED))
                {
                ...
                else if (instance->GetBossState(BOSS_ARGENT_CHALLENGE) == DONE && (instance->GetBossState(BOSS_BLACK_KNIGHT) == NOT_STARTED || instance->GetBossState(BOSS_BLACK_KNIGHT) == TO_BE_DECIDED))
                {
